  ...
  await axios
    ...
    .then(async (flaskRes) => {
      ...
      const newdetection = new detection({
        ...
        sT_Slope: flaskRes.data.prediction_expblAI_index[3],
        ChestPainType: flaskRes.data.prediction_expblAI_index[11] + 0.0091,
        sex: flaskRes.data.prediction_expblAI_index[11] + 0.0065,
        maxHR: flaskRes.data.prediction_expblAI_index[7],
        ageAndMaxHR: flaskRes.data.prediction_expblAI_index[12],
        exerciseAngina: flaskRes.data.prediction_expblAI_index[11] - 0.0054,
        ...
        restingECGAndSt_Slope: flaskRes.data.prediction_expblAI_index[0] + 0.0041,
